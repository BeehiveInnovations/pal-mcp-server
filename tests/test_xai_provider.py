...
class TestXAIProvider:
    ...
    def test_get_capabilities_grok4_1_fast_reasoning(self):
        ...
        # Test that aliases also work
        capabilities_alias = provider.get_capabilities("grok-4.1-fast")
        ...
        capabilities_alias2 = provider.get_capabilities("grok-4-1-fast")
        assert capabilities_alias2.model_name == "grok-4-1-fast-reasoning"
